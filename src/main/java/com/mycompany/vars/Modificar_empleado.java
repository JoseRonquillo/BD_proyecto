 ...
 * @author chatman
 */
public class Modificar_empleado extends javax.swing.JPanel {

    JPanel panel_general;
    public Modificar_empleado(JPanel panel_general) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tl.modificar_empleado(txtNombre.getText(),txtPermisos.getSelectedItem().toString(),txtUsuario.getText(),txtContrasena.getText());
        Empleados emp = new Empleados(panel_general);
        emp.setSize(807,511);
        emp.setLocation(0,0);
        panel_general.removeAll();
