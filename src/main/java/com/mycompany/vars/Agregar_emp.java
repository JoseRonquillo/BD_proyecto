 ...
 * @author chatman
 */
public class Agregar_emp extends javax.swing.JPanel {

    JPanel panel_general;
    public Agregar_emp(JPanel panel_general) {
    ...
    private void initComponents() {
        ...
        txtPermisos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Encargado","Empleado" }));
        txtPermisos.setBorder(BorderFactory.createMatteBorder(0,0,1,0, cl));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtPermisos, 0, 300, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Empleados emp = new Empleados(panel_general);
        emp.setSize(807,511);
        emp.setLocation(0,0);
        panel_general.removeAll();
        panel_general.add(emp,BorderLayout.CENTER);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tl.crear_empleado(txtNombre.getText(), txtPermisos.getSelectedItem().toString(), txtUsuario.getText(), txtContrasena.getText());
        txtNombre.setText("");
        txtUsuario.setText("");
